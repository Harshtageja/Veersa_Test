...
$sql = "SELECT registered_patient.patient_name FROM registered_patient where Email='".$_COOKIE['Email']."'";
...
if ($result->num_rows > 0) {
  ...
  echo "0 results";
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    ...
                    <a href="about.html" class="nav-item nav-link">Book Appointment</a>
    ...
    <div class="jumbotron jumbotron- mb-5">
        <div class="container text-center py-5">
           ...
           <div class="row">
  <div class="col-sm-6">
    <div class="card" style="margin-left: 50%;padding-top: 2rem;padding-right: 2 rem;margin-right: -12rem;border-radius: 6%;width: 120%;">
        <h3>Appointments</h3>
      <div class="card-body">
  ...
  <tbody>
    <?php
        $sql = "SELECT registered_patient.patient_name,Final_Appointment.doctor_id,Final_Appointment.slot,Final_Appointment.status FROM registered_patient left join Final_Appointment on Final_Appointment.Patient_id=registered_patient.Email where Email='".$_COOKIE['Email']."'";
$result = $conn->query($sql);
if ($result->num_rows > 0 ) {
  // output data of each row
  while($row = $result->fetch_assoc()) {
...
if($row['status']=='Finished'){
        ...
        ?>
         <input type="hidden" name="Patient_id" value="<?php echo $row['doctor_id'] ?>">
      <td><button name="nine" type="submit"value="<?php echo $row['slot']?>" class="btn btn-primary">Review</button></td>
   ...
   <?php
    ...
    ?>
    <td><h5 style="color: grey;">To Be</h5></td>
    <?php
  }
  ?>
</tr>
